...
public class Model {
    ...
    private Model(){
        ...
        addStudent(new Student("Maya" , "384129698" , "0524485566","Telmond" , false));
        addStudent(new Student("Keren" , "129157285" , "052121111","Tel aviv" , false));
        addStudent(new Student("Mor" , "123174695" , "0524148225","Hertzeliya" , false));
        addStudent(new Student("Shoval" , "892356487" , "0523658894","Reshon Lezion" , false));
